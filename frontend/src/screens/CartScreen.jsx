                ...
                {cartItems.map((item) => (
                    <ListGroup.Item key={item._id}>
                        <Row>
                            ...
                            <Col md={2}>
                                <Button type='button' variant='light' onClick={(e) => removeFromCartHandler(item)}>
                                    <FaTrash/>
                                </Button>
                            </Col>
                        </Row>
    ...
    <Col md={4}>
        <Card>
            <ListGroup variant='flush'>
                ...
                <ListGroup.Item>
                <Button type="button" className='btn btn-block' disabled={cartItems.length === 0 ? true:false} onClick= {checkoutHandler}> Proceed To Checkout</Button>
